...
#define  pi         acos(-1.0)
#define  cos(n)     cos(n*pi/180)
#define  sin(n)     sin(n*pi/180)
#define  tan(n)     tan(n*pi/180)
#define  cosi(n)    acos(n)/(pi/180)
#define  sini(n)    asin(n)/(pi/180)
#define  tani(n)    atan(n)/(pi/180)
