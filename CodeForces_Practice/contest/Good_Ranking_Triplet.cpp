...
int main()
{
    ...
    while(t--){
        ...
        for (size_t i = 0; i <= 8; i++)
        {
            ...
            // cout<<a<<endl;
            // cout<<b<<endl;
            for(auto i:a) _1.pb(i);
            for(auto i:b) _1.pb(i);
            for(auto i:b) _2.pb(i);
            for(auto i:a) _2.pb(i);
            reverse(all(a));
            reverse(all(b));
            for(auto i:a) _3.pb(i);
            for(auto i:b) _3.pb(i);
            for(auto i:b) _4.pb(i);
            for(auto i:a) _4.pb(i);
            vv.pb(_1);
            vv.pb(_2);
            vv.pb(_3);
            vv.pb(_4);
